...
public class DatabaseIntegrationTest {
    ...
    public void testCreateUserBalance() {
        ...
        userBalance.setAmount(new BigDecimal(1.5));
        ...
        assertThat(foundUserBalance.get().getAmount()).isEqualByComparingTo(new BigDecimal("1.50"));
    }
    ...
    public void testCreateOrderHistory() {
        ...
        orderHistory.setPrice(new BigDecimal(50000.0));
        orderHistory.setQuantity(new BigDecimal(0.1));
        ...
        assertThat(foundOrderHistory.get().getPrice()).isEqualByComparingTo(new BigDecimal("50000.00"));
